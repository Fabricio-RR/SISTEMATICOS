...
// Bloques reutilizables para mostrar cuando no hay datos ("Vacío") o mientras
// están cargando (placeholders grises animados que imitan el contenido).
...
/** Esqueleto de tabla de posiciones (filas con brillo deslizante). */
