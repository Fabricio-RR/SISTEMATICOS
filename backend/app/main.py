...
from app.routers import auth, instituciones, usuarios, deportes, club_equipo, torneos, sedes, noticias, inscripciones, grupos, fixture, partidos, atleta_jugador, estadisticas
